const en = {
  ...
  /* ═══ FOOTER ═══ */
  footer: {
    desc: "I help organizations communicate clearly, build trust, and connect with the people they need to reach.",
    ...
    strategicComms: "Strategic Communications",
  ...
  about: {
    ...
    experience: [
      {
        ...
        dates: "2025 — Present",
        summary:
          "I support research that strengthens digital rights advocacy and makes complex findings easier to share with wider audiences.",
        highlights: [
          "Conduct literature reviews and synthesize findings into clear research outputs.",
          "Contribute to conference presentations and visibility for research across Africa.",
        ],
      },
      {
    ...
    processSteps: [
      ...
      },
      {
        ...
        desc: "I create the work, roll it out across the right channels, and keep the message consistent from start to finish.",
      },
      {
        num: "04",
    ...
    values: [
      {
        ...
        desc: "I measure success not by volume, but by meaningful change in awareness, behavior, and engagement.",
      },
      {
        title: "Empathy-Led Strategy",
        desc: "Every strong communication plan starts with listening and understanding the people I need to reach.",
      },
      {
        title: "Collaborative Spirit",
        desc: "Great communications work happens in partnership. I thrive in collaborative, cross-functional teams.",
      },
    ],
  },
    ...
    items: [
      {
        id: "strategic-comms",
        title: "Strategic Communications",
        desc: "I build communication strategies that connect audience insight with practical execution.",
        features: [
          "Communication audits & gap analysis",
          "Messaging frameworks & key message development",
          "Multi-channel campaign strategy & planning",
          "Stakeholder mapping & engagement plans",
      ...
      },
      {
        ...
        desc: "I create content that sounds clear, feels human, and works across the channels you actually use.",
        features: [
          "Content strategy & editorial calendar development",
          "Blog writing & thought leadership articles",
          "Social media content & community management",
          "Newsletter & email campaign copywriting",
      ...
      },
      {
        ...
        features: [
          ...
          "Brand launch & rebrand campaigns",
  ...
  caseStudiesPage: {
    ...
    title: "Case Studies",
    subtitle:
      "Real communications challenges, strategic solutions, and measurable outcomes. Explore how I've delivered impact across campaigns, media, and advocacy.",
    viewDetails: "View Full Case Study",
    ctaTitle: "Have a project in mind?",
    ctaDesc:
      "I'd love to learn about your communications challenges and explore how I can help deliver measurable results.",
    ctaButton: "Start a Conversation",
    items: [
      {
  ...
  caseStudyDetail: {
    ...
    data: {
      "community-campaigns": {
        ...
        deliverables: [
          "30+ multi-channel campaigns across digital, print, and radio",
          "Unified brand messaging guidelines and content style guide",
          "Monthly analytics reports with actionable recommendations",
          "Media kits and press releases for advocacy events",
          "Social media content calendars and community engagement protocols",
        ],
        results: [
          { value: "35%", label: "Engagement Increase" },
          { value: "30+", label: "Campaigns Launched" },
          { value: "3x", label: "Social Media Growth" },
      ...
      "digital-rights-research": {
        ...
        deliverables: [
          "Comprehensive literature reviews on digital rights in Africa",
          "Research reports and policy briefs",
          "Conference presentations and panel contributions",
          "Collaborative research with cross-continental teams",
        ],
        results: [
          { value: "Pan-African", label: "Research Scope" },
          { value: "3+", label: "Conference Presentations" },
          { value: "Multi", label: "Country Coverage" },
      ...
      "brand-social-media": {
        ...
        deliverables: [
          "Social media strategy document with content pillars",
          "Monthly content calendars and visual templates",
          "Crisis communication protocol and response framework",
          "Weekly analytics reports and optimization recommendations",
          "Community management guidelines and engagement playbook",
        ],
        results: [
          { value: "60%", label: "Follower Growth" },
      ...
      "mental-health-comms": {
        ...
        deliverables: [
          ...
          "Press conference planning and media outreach",
          "Social media campaigns for global awareness days",
          "Content calendars with mental health messaging guidelines",
          "Post-campaign analytics and impact reports",
        ],
        results: [
          { value: "45%", label: "Engagement Increase" },
          { value: "5+", label: "Press Events" },
          { value: "3", label: "Awareness Campaigns" },
          { value: "2x", label: "Media Coverage" },
        ],
      },
    },
  },
  ...
  contact: {
    ...
    subtitle:
      "If you have a project in mind, need communication support, or want to talk about a role, I'd love to hear from you.",

    emailLabel: "Email",
    locationLabel: "Location",
    locationValue: "Buea, Cameroon · Open to remote & international",
    responseLabel: "Response Time",
    responseValue: "Within 1 to 2 business days",
    ...
    inquiryProject: "Project Inquiry",
    inquiryHire: "Full-time Hire",
